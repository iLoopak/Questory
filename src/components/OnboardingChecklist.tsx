...
function PersonalizeStep({ accentColorPreference, appTemplatePreference, gameCount, libraryOwnerNickname, onAccentColorChange, onAppTemplatePreferenceChange, onComplete, onLibraryOwnerNicknameChange, onShelfIdentityChange, personalizedQuestShelfTitle, platformCount, shelfIdentity, steamAvatarUrl, steamPersonaName }: { accentColorPreference: AccentColorPreference; appTemplatePreference: AppTemplatePreference; gameCount: number; libraryOwnerNickname: string; onAccentColorChange: (color: AccentColorPreference) => void; onAppTemplatePreferenceChange: (preference: AppTemplatePreference) => void; onComplete: () => void; onLibraryOwnerNicknameChange: (nickname: string) => void; onShelfIdentityChange: (identity: ShelfIdentitySettings) => void; personalizedQuestShelfTitle: string; platformCount: number; shelfIdentity: ShelfIdentitySettings; steamAvatarUrl: string; steamPersonaName: string }) {
  ...
  const shelfExamples = [steamPersonaName ? `${steamPersonaName}’s QuestShelf` : '', "Loopak's QuestShelf", 'My QuestShelf'].filter(Boolean);
  const previewTitle = personalizedQuestShelfTitle || (libraryOwnerNickname ? formatPersonalizedQuestShelfTitle(libraryOwnerNickname) : formatPersonalizedQuestShelfTitle('My QuestShelf'));
