...
function RawgLinkDialog({ game, onClose, onSelect }: { game: Game; onClose: () => void; onSelect: (result: RawgSearchResult) => void }) {
  const [query, setQuery] = useState(() => game.metadataSearchTitle || game.displayTitleOverride || game.title);
