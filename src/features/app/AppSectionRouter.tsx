...
type AppRouterDiscoveryKeys = 'discoveryInboxItems' | 'discoveryInboxRawgIds' | 'handleSelectDiscoveryGame' | 'openDiscoveryPreview' | 'addToDiscoveryInbox' | 'promoteDiscoveryToWishlist' | 'promoteDiscoveryToPlans' | 'promoteInboxDiscoveryToLibrary' | 'promoteInboxDiscoveryToWishlist' | 'promoteInboxDiscoveryToPlans' | 'handleInboxIgnore' | 'handleInboxSkip' | 'startDiscoveryInboxRun';
