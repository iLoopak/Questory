...
type MetadataRouteProps = Pick<AppSectionRouteModel, 'games' | 'metadataSelectionRequest' | 'updateGameMetadataManagement' | 'markOnboardingItemComplete' | 'updateGameMetadata'>;
