...
export const questShelfAchievementRegistry: QuestShelfAchievement[] = [
  ...
  },
  {
    ...
    title: 'Collector',
    icon: 'archive',
    description: 'Your Questory library has grown into a collection.',
  ...
  // ── Usage / Fun ───────────────────────────────────────────────────────────
  {
    ...
    icon: 'sparkles',
    description: 'Opened Questory on 30 unique days.',
    descriptionCs: 'Questory otevřen celkem 30 různých dní.',
    unlockCondition: 'Open Questory on 30 unique days.',
    priority: 125,
    colorVariant: 'primary',
    target: 30,
  ...
  },
  {
    ...
    titleCs: 'Noční sova',
    icon: 'eye-off',
    description: 'Opened Questory between midnight and 5 AM.',
    descriptionCs: 'Questory otevřen mezi půlnocí a 5 ráno.',
    unlockCondition: 'Open Questory between 00:00 and 05:00.',
    priority: 33,
    colorVariant: 'secondary',
    target: 1,
  ...
  },
  {
    ...
    titleCs: 'Ranní ptáče',
    icon: 'sparkles',
    description: 'Opened Questory between 5 AM and 6 AM.',
    descriptionCs: 'Questory otevřen mezi 5 a 6 ráno.',
    unlockCondition: 'Open Questory between 05:00 and 06:00.',
    priority: 32,
    colorVariant: 'primary',
    target: 1,
  ...
  },
  {
    ...
    icon: 'search',
    description: 'Opened Questory 10 times.',
    descriptionCs: 'Questory otevřen 10×.',
    unlockCondition: 'Open Questory 10 times.',
    priority: 31,
    colorVariant: 'mixed',
    target: 10,
  ...
  },
  {
    ...
    icon: 'rocket',
    description: 'Your library was created in the first year of Questory.',
    descriptionCs: 'Vaše knihovna vznikla v prvním roce Questoryu.',
    unlockCondition: 'Add your first game during the first year of Questory.',
    priority: 190,
    colorVariant: 'primary',
    isMeta: true,
    target: 1,
